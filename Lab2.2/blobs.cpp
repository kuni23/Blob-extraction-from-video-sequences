...
//Trained RATIO MODELS

#define MEAN_PERSON_T 0.3950
#define STD_PERSON_T 0.1731

#define MEAN_CAR_T 1.5941
#define STD_CAR_T 0.4169

#define MEAN_OBJECT_T 1.2111
#define STD_OBJECT_T 0.4470
 ...
 int classifyBlobs(std::vector<cvBlob> &bloblist)
 {
	...
	vector<double> diff;
 	...
 	for(int i = 0; i < bloblist.size(); i++)
 	{
 		...
 		{
 			//Basic aspect ratio model
 			//if(abs(ratio-MEAN_CAR_T)<abs(ratio-MEAN_OBJECT_T))
